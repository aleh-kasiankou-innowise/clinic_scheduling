...
public class SchedulingDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Shift>().Property(x => x.ShiftStart).HasColumnType("time");
        modelBuilder.Entity<Shift>().Property(x => x.LunchStart).HasColumnType("time");
        modelBuilder.Entity<Shift>().Property(x => x.WorkingHours).HasColumnType("time");
        ...
        modelBuilder.Entity<Schedule>()
            .Property(x => x.Day).HasColumnType("date");
